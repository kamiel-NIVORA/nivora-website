...
const SLIDES: Slide[] = [
  { img: '/service-appdesign.png', tagline: 'Your idea, your app' },
  { img: '/service-localai.png', tagline: 'Own AI, own data' },
  { img: '/service-aios.png', tagline: 'Your company, automated' },
  { img: '/service-consulting.png', tagline: 'Where AI actually fits' },
]
...
export function ServicesShowcase() {
  ...
  return (
    <div ref={ref} className="relative aspect-[16/10] w-full overflow-hidden">
      ...
      <img src="/IMG_0702.JPG" alt="" className="absolute inset-0 h-full w-full object-cover" />
