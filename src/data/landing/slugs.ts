...
export const LANDING_ENTRIES = [
  ...
  /* ── sectoren ──
     14 september 2026 ('s avonds): ook de architectenpagina en de vijf
     aanbodpagina's onder /architecten/ op draft, op vraag van Kamiel. Het
     aanbod voor architecten wordt herwerkt tot de Werfnota; tot die pagina
     klaar is staat er van de sectoren niets online.
