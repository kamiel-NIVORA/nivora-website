...
export const SERVICE_CONTENT: Record<ServiceSlug, ServiceContent> = {
  "app-design": {
    ...
    "problem": {
      ...
      "intro": "There's a point where the workarounds cost more than the tool saves. You're probably past it.",
      "points": [
        {
          "title": "Spreadsheets holding it together",
          "body": "Critical work lives in a tangle of sheets only one person fully understands. It breaks quietly, and every fix is manual."
        },
        {
    ...
    "capabilities": {
      ...
      "items": [
        {
          "title": "Discovery and UX",
          "body": "We map how your business actually works before we design anything. The app follows your process, not a generic playbook."
        },
        {
        ...
        },
        {
          ...
          "body": "Your app talks to the systems you already run on, so it fits your workflow instead of becoming another island."
        },
        {
          "title": "AI where it actually helps",
          "body": "We add AI only where it saves real time on real tasks. No AI for the sake of it. No bloat."
        },
        {
          "title": "Launch and iterate",
          "body": "We ship it, watch how it's used, and refine. The first version is the start, not the finish."
        }
      ]
    },
    "process": {
      ...
      "steps": [
        {
          ...
          "body": "We sit with you and your team to understand the idea, the process, and where it hurts. We scope the real problem before writing a line of code."
        },
        {
          "label": "02",
        ...
        },
        {
          ...
          "body": "Full-stack build, connected to your tools, on clean foundations that hold up as you grow. We show progress as we go."
        },
        {
          "label": "04",
          "title": "We stay with you",
          "body": "We launch, watch how it's used, and keep improving it. You're not handed a zip file and left alone."
        }
      ]
    },
    "differentiators": {
      ...
      "items": [
        {
          "title": "Builders, not a vendor",
          "body": "We write the code ourselves. You talk to the people building your product, not an account manager relaying messages."
        },
        {
          "title": "Your process drives the design",
          "body": "We don't make you fit our framework. We learn how you work and build software that matches it."
        },
        {
        ...
        {
          "title": "Built to last",
          "body": "Clean foundations, no bloat, room to grow. We build it once, properly, so you're not rebuilding in a year."
        }
      ]
    },
    "audience": {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "Yes. The code, the data, and the product are yours. No lock-in. If you ever want to bring it in-house or move it elsewhere, you can."
      },
      {
      ...
      },
      {
        ...
        "a": "Book a strategy call. We'll talk through your idea and your process, and give you a straight answer on whether custom software is the right move and what it would take."
      }
    ],
    "finalCta": {
  ...
  "local-ai": {
    ...
    "problem": {
      ...
      "intro": "The teams that need AI most are often the ones who can't touch the easy tools. Every prompt to a cloud model is a question you can't answer: where does this end up, who can read it, and what did we agree to in the fine print?",
      "points": [
        {
        ...
        },
        {
          ...
          "body": "Regulators and clients expect you to know exactly where their information lives. \"We sent it to a third-party AI vendor\" is not an answer you want to give in an audit or a breach review."
        },
        {
          "title": "Per-seat pricing and lock-in keep climbing",
          "body": "Every new user is another monthly fee, and your workflows quietly get welded to one provider's prices and roadmap. You're renting capability you could own outright."
        }
      ]
    },
    "solution": {
      ...
      "items": [
        {
          ...
          "body": "We look at what you already have and what you'd need. You get a straight answer on whether to run on your own servers or on dedicated hardware we manage for you."
        },
        {
        ...
        },
        {
          ...
          "body": "The whole system runs inside your perimeter. Data stays in-house by design, not by promise, and we build to your security requirements from day one."
        },
        {
        ...
        },
        {
          ...
          "body": "Who can use it, what they can reach, and a record of what happened. The controls and trail your compliance team needs to sign off without hesitation."
        },
        {
      ...
      "steps": [
        {
          "label": "01",
          "title": "We listen first",
          "body": "We map your data, your compliance obligations, and what you actually want AI to do. Before any hardware or models, we get clear on the constraints you can't break."
        },
        {
          "label": "02",
          "title": "We design what fits",
        ...
        {
          "label": "03",
          "title": "We build and deploy securely",
    ...
    "differentiators": {
      ...
      "items": [
        {
          "title": "You own the system, not a subscription",
          "body": "When we're done, the AI runs on your infrastructure under your control. There's no per-seat meter and no switch a provider can flip to change your terms."
        },
        {
        ...
        },
        {
          ...
          "body": "Self-hosting AI properly means handling models, infrastructure, access, and audit together. We build the whole thing, so the privacy is real, not a checkbox."
        },
        {
          "title": "We stay after launch",
          "body": "Private AI needs upkeep as models and threats evolve. We keep yours current, so you keep the capability without inheriting a maintenance burden."
        }
      ]
    },
    "audience": {
    ...
    "faq": [
      {
        "q": "How long does it take to get a private AI running?",
        "a": "It depends on your infrastructure and how many of your documents the assistant needs to reach. A focused first deployment is a matter of weeks, not months. We give you a clear timeline after the assessment, before any work starts."
      },
      {
        "q": "Do we actually own it, or are we tied to you?",
        "a": "You own it. The system runs on infrastructure you control, and you're not locked into us. We stay on for maintenance because it's genuinely useful, not because you can't leave."
      },
      {
        "q": "How private is it, really?",
        "a": "Nothing goes to public models like OpenAI. The models run inside your environment, your data stays behind your own walls, and we set up access control and an audit trail so you can prove exactly who touched what."
      },
      {
        "q": "We already use ChatGPT or another cloud tool. Why change?",
        "a": "If your data isn't sensitive, you may not need to. But if you're pasting confidential material into a tool you don't control, you're carrying a risk most teams underestimate. Local AI gives you the capability without the exposure."
      },
      {
        "q": "Do we need our own servers and a technical team?",
        "a": "No. We can deploy on your hardware if you have it, or run it on dedicated infrastructure we manage for you. Either way, we handle the technical side and hand you a system that just works."
      },
      {
  ...
  "aios": {
    ...
    "problem": {
      "title": "Your company runs on a pile of tools that don't talk to each other",
      "intro": "It grew one app at a time. Notion for docs, Sheets for the numbers, a CRM, Slack, ten browser tabs. Each made sense on its own. Together, they cost your team hours every single day.",
      "points": [
        {
        ...
        },
        {
          ...
          "body": "Two tools show two different totals and nobody's sure which to trust. You end up deciding on figures you only half believe, because the tools never agree on the real picture."
        }
      ]
    },
    "solution": {
    ...
    "capabilities": {
      ...
      "items": [
        ...
        },
        {
          ...
          "body": "The real picture of your business in one view, drawn from one source of truth. The numbers agree because they all come from the same place."
        },
        {
          "title": "Rollout and team training",
          "body": "We install it, move your data in, and train your team so they actually adopt it. Then we stay with you after launch as the business changes."
        }
      ]
    },
    "process": {
      ...
      "steps": [
        ...
        },
        {
          ...
          "body": "We shape the data model and the modules around your operations, and agree on what AIOS replaces and in what order. You see the plan before a line is built."
        },
        {
          "label": "03",
          "title": "We build what fits",
          "body": "We build your modules, automation, and AI agents, then migrate your data and connect what stays. We start with the part that hurts most, so you feel the value early."
        },
        {
          "label": "04",
          "title": "We stay with you",
    ...
    "differentiators": {
      ...
      "items": [
        ...
        {
          "title": "You own it",
          "body": "Your system, your data, your platform. No lock-in to a tool you can't change, no per-seat tax on growing your team. It runs for the business, not for the vendor."
        },
        {
          "title": "Private by design",
          "body": "Your knowledge and operations stay yours. We build with privacy and control from the start, so your data isn't quietly feeding someone else's product."
        },
        {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "Not blindly. In the mapping phase we decide together what AIOS replaces and what's worth keeping and connecting. The goal is one source of truth, not change for its own sake. If a tool genuinely serves you, we connect to it instead of rebuilding it."
      },
      {
        "q": "What if our team resists a new system?",
        "a": "That's exactly why rollout and training are part of the build, not an afterthought. We start with the workflow that removes the most daily pain, so people feel the benefit fast, and we stay with you through adoption. A system nobody uses isn't worth building."
      },
      {
        "q": "How do we get started?",
  ...
  "ai-consulting": {
    ...
    "hero": {
      ...
      "headline": "Know exactly where AI helps your business before you spend a cent building it.",
      "subhead": "We learn how your team works today, find where AI actually pays off, and hand you a ranked roadmap with small pilots that prove value first. A plan before the build, not after.",
      "primaryCta": "Book a strategy call",
      "secondaryCta": "Contact us"
    },
    "intro": {
      "statement": "Most AI spend fails because it starts with a tool instead of a problem. We start with how you actually work, then find where AI earns its place.",
      "chips": [
        "Plan first",
        "Honest ROI",
        "You own it"
    ...
    "problem": {
      ...
      "intro": "Most founders we talk to are in the same spot: the expectation is clear, the path is not.",
      "points": [
        {
          "title": "Pressure with no direction",
          "body": "Everyone says you should be using AI. Nobody tells you where it fits in your business. So you sit on it, or you guess."
        },
        {
          "title": "Burned by the hype",
          "body": "You tried a tool or two. They demoed well, then quietly died in the team. Now you're skeptical of the next shiny thing, and you're right to be."
        },
        {
          "title": "Afraid of betting on the wrong thing",
          "body": "A real AI build is real money. Committing before you know it's the right move is how good companies waste a quarter and lose trust internally."
        }
      ]
    },
    "solution": {
      "title": "We find where AI fits, prove it works, then tell you what to build.",
      "body": "This is the step before the big build. We get inside how your business runs today, find every place AI could genuinely help, and put honest numbers next to each one. Then we run small, hands-on pilots so you see real results before you commit budget to anything. You leave with a plan you can act on, not a slide deck.",
      "outcomes": [
      ...
      "items": [
        {
          ...
          "body": "We sit with you and your team to map how the work really gets done today, where time leaks, and what's quietly costing you."
        },
        {
          "title": "Opportunity mapping with honest ROI",
          "body": "Every idea gets a number and a verdict. We tell you which ones pay off, which ones don't, and why, so you fund the right ones."
        },
        {
          "title": "Workflow and automation design",
          "body": "We design the flows end to end, so it's clear exactly how the work changes and who touches what."
        },
        {
          "title": "Build vs buy calls",
          "body": "For each opportunity we tell you straight: use an existing tool, or build something custom. No bias toward selling you a build."
        },
        {
          "title": "A ranked roadmap",
          "body": "Everything lands in one ordered plan, sequenced by impact and effort, that any team could pick up and act on tomorrow."
        },
        {
          "title": "Hands-on pilots",
          "body": "We don't just recommend. We stand up small working pilots so you see the result with your own eyes before committing real budget."
        }
      ]
    },
    "process": {
      ...
      "steps": [
        {
          "label": "01",
          "title": "We listen first",
          "body": "We learn your business from the inside: how the team works, where it hurts, what good would actually look like. No assumptions, no template."
        },
        {
          "label": "02",
          "title": "We map and prove",
          "body": "We find every real opportunity, put honest ROI next to each, and run quick pilots so the strongest ones are tested, not just theorized."
        },
        {
          "label": "03",
          "title": "We hand you the plan",
          "body": "You get a ranked roadmap with clear build vs buy calls. It's yours to act on, with us or without us."
        },
        {
          "label": "04",
          "title": "We stay with you",
          "body": "When you're ready to build, we're still here. The same people who wrote the plan can build it, so nothing gets lost in translation."
        }
      ]
    },
    "differentiators": {
      ...
      "items": [
        {
          "title": "We build, so the plan is buildable",
          "body": "Our roadmaps come from people who ship real systems. Nothing in your plan is a slide that can't survive contact with reality."
        },
        {
          "title": "We have no tool to sell you",
          "body": "Our build vs buy calls are honest because we don't win when you over-build. If an off-the-shelf tool is the right answer, we'll say so."
        },
        {
          "title": "Proof before spend",
          "body": "We'd rather show you a working pilot than promise an outcome. You commit budget once you've seen it work, not before."
        },
        {
          "title": "Clarity over jargon",
          "body": "You'll understand every recommendation and the reason behind it. Built with clarity, built to last, applies to the thinking too."
        }
      ]
    },
    "audience": {
    ...
    "faq": [
      {
        ...
        "a": "Most engagements run a few weeks from first conversation to roadmap, with early pilots inside that window. We scope it on the strategy call once we understand your situation, and we don't pad it."
      },
      {
        "q": "Do we own what you produce?",
        "a": "Yes. The audit, the roadmap, the pilots, all of it is yours. You can act on it with us, with another team, or in-house. There's no lock-in built into the plan."
      },
      {
        "q": "How do you handle our data and security?",
        "a": "We treat your data as yours. We only access what we need to do the work, we're explicit about where anything runs, and if privacy is critical we'll design around keeping things on your own infrastructure."
      },
      {
        "q": "We already have some AI tools in place. Is this still worth it?",
        "a": "Often more so. Part of the audit is judging what's already working, what's quietly failing, and what to keep, drop, or replace, so you stop paying for things that don't stick."
      },
      {
        "q": "What if the honest answer is that AI doesn't help us much?",
        "a": "Then we'll tell you, plainly. Knowing where AI doesn't fit saves you more than another vendor's roadmap ever will. That's a real outcome, not a failed engagement."
      },
      {
        "q": "How do we get started?",
        "a": "Book a strategy call. We'll talk through where you are and give you a straight answer on whether this is the right fit. We usually reply within a day."
      }
    ],
    "finalCta": {
