...
export const SERVICE_META: Record<ServiceSlug, ServiceMeta> = {
  ...
  'local-ai': {
    ...
    heroImage: '/bg-waves-mono.jpg',
    photo: '/bg-waves-mono.jpg',
  ...
  aios: {
    ...
    name: 'AIOS',
    icon: '/icon-aios.png',
    tile: '/service-aios.webp',
    heroImage: '/IMG_0683.webp',
    photo: '/nature-aios.webp',
    anim: '/anim-aios.mp4',
    mockup: '/mockup-aios.webp',
    heroVideo: 'orbit',
  ...
  'ai-consulting': {
    ...
    tile: '/service-consulting.webp',
    heroImage: '/IMG_0640.webp',
    photo: '/nature-consulting.webp',
    anim: '/anim-consulting.mp4',
    mockup: '/mockup-consulting.webp',
    heroVideo: 'spark',
