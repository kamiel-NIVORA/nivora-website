...
export const SERVICE_META: Record<ServiceSlug, ServiceMeta> = {
  'app-design': {
    ...
    heroImage: '/backgrounds/bg-waves.webp',
    photo: '/services/nature-appdesign.webp',
  ...
  'local-ai': {
    ...
    heroImage: '/backgrounds/bg-waves-mono.jpg',
    photo: '/backgrounds/bg-waves-mono.jpg',
  ...
  aios: {
    ...
    heroImage: '/products/IMG_0683.webp',
    photo: '/services/nature-aios.webp',
  ...
  'ai-consulting': {
    ...
    heroImage: '/services/IMG_0640.webp',
    photo: '/services/nature-consulting.webp',
